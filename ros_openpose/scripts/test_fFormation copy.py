...
class F_formation:
    ...
    def createFFormations(self, msg, index, data):
        ...
        print(f"{index+1}Personers executable time: ",end - self.start)
    ...
    def testData(self):
        ...
        frame33=[p331,p332,p333,p334,p335,p336,p337,p338]
        ...
        frame1=[p1, p2]
        frame2=[p331,p332,p333]
        frame3=[p331,p332,p333,p334]
        frame4=[p331,p332,p333,p334,p335]
        frame5=[p331,p332,p333,p334,p335,p336]
        frame6=[p331,p332,p333,p334,p335,p336,p337]
        frame7=[p331,p332,p333,p334,p335,p336,p337,p338]
        frame8=[p1, p331,p332,p333,p334,p335,p336,p337,p338]
        frame9=[p1, p2, p331,p332,p333,p334,p335,p336,p337,p338]
        data = [frame1,frame2,frame3,frame4,frame5,frame6,frame7,frame8,frame9]
        return data

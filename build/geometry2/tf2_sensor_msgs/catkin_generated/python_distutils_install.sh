...
echo_and_run cd "/home/axel/P5/src/geometry2/tf2_sensor_msgs"
...
=======
    ...
    "/usr/bin/python2" \
    "/home/axel/P5/src/geometry2/tf2_sensor_msgs/setup.py" \
>>>>>>> c0686da4ef00f543f3e2534c55792ba20b859868
     \
    build --build-base "/home/axel/P5/build/geometry2/tf2_sensor_msgs" \
    install \
    --root="${DESTDIR-/}" \

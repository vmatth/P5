#include "robot_setup_tf/local_planner.h"
#include <pluginlib/class_list_macros.h>
PLUGINLIB_DECLARE_CLASS(local_planner, LocalPlanner, local_planner::LocalPlanner, nav_core::BaseLocalPlanner)
//PLUGINLIB_EXPORT_CLASS(simple_local_planner::LocalPlanner, nav_core::BaseLocalPlanner)

namespace local_planner{

        simple_local_planner::LocalPlanner::LocalPlanner() : costmap_ros_(NULL), tf_(NULL), initialized_(false) {}

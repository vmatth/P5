...
struct LeaseArray_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::spot_msgs::LeaseResource_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::spot_msgs::LeaseResource_<ContainerAllocator> >::other >  _resources_type;

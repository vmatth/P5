...
struct FootStateArray_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::spot_msgs::FootState_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::spot_msgs::FootState_<ContainerAllocator> >::other >  _states_type;
  _states_type states;

...
struct BatteryStateArray_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::spot_msgs::BatteryState_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::spot_msgs::BatteryState_<ContainerAllocator> >::other >  _battery_states_type;
